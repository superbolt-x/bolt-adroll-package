...
{%- set exclude_fields = ['date','day','week','month','quarter','year','last_updated','unique_key','kpi_metric','source','kpi_currency','kpi_goal','spend_limit_until','spend_limit_until_reason'] -%}
